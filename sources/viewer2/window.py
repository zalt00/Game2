...
class Window(pyglet.window.Window):
    def __init__(self, width, height, *args, **kwargs):
        ...
        self.init_joys()
        pyglet.font.load('resources/fonts/m3x6.ttf')
        pyglet.font.load('resources/fonts/m5x7.ttf')
        ...
        self.fg_group = sprite_set.SpriteSet()

        self.particle_group = sprite_set.SpriteSet()
        self.entity_group = sprite_set.SpriteSet()
        self.button_group = sprite_set.SpriteSet()

        self.game_objects_group = sprite_set.SpriteSet()
        self.text_group = sprite_set.SpriteSet()
    ...
    def render_font(self, txt, size, passive_color, active_color, width=0, height=0, rectangle=0):
        ...
        raise RuntimeError('not the way we do anymore, see the sprites.Button class')
